    ...
    <section className="page-section" id="services">
      <div className="container">
        ...
        <div className="row text-center">
          <Link href="/support-for-startups/">
            <a className="col-lg-3 col-sm-6" title="A mission for startups">
              ...
              <p className="text-muted">
                French Tech helps all members of its ecosystem to create exchanges and help them
                grow.
              </p>
            </a>
          </Link>
          <Link href="/french-tech-visa/">
            <a className="col-lg-3 col-sm-6" title="Get a French Tech Visa">
              <span className="fa-stack fa-4x">
                <i className="fas fa-circle fa-stack-2x text-primary"></i>
              ...
              <p className="text-muted">
                One of the latest initiatives to attract foreign talent to France is the
                introduction of the French Tech Visa.
              </p>
            </a>
          </Link>
          <Link href="/community-fund/">
            <a className="col-lg-3 col-sm-6" title="About the community fund">
              <span className="fa-stack fa-4x">
                <i className="fas fa-circle fa-stack-2x text-primary"></i>
          ...
          <Link href="/events/">
            <a className="col-lg-3 col-sm-6" title="Attend our events">
              <span className="fa-stack fa-4x">
                <i className="fas fa-circle fa-stack-2x text-primary"></i>
